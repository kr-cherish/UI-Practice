...
const SecondSection = () => {
    return (
        <div className='bg-[#C4C4C40D] lg:pb-5 lg:rounded-[20px]' >
            <div className='text-white bg-[#C4C4C40D] font-bold mt-3 lg:mt-15 lg:text-[24px] md:text-[20px] text-[10px] lg:px-20 lg:py-5  md:p-3 md:rounded-[20px] p-2 rounded-[10px]'>Check your COVID-19 result on our Database</div>
            <div className="flex lg:items-center gap-3 justify-center lg:mt-7 md:mt-5 mt-3 lg:flex-row flex-col lg:px-50 lg:py-5 md:px-40 md:py-2">
                <div className=" border-[3px] border-sky-300 lg:rounded-[20px] md:rounded-[10px] p-2 mt-3  lg:h-[69px]  md:h-[482px]  h-[50px] text-white flex-1 rounded-[10px]">
                    Okeowo
                </div>
